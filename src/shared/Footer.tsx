...
const BUILT_IN_SITE_LABELS: Record<string, Record<SiteLabelsKey, string>> = {
  ...
  de: { hotelDeals:'Handverlesene Hotelangebote',staysCabins:'Unterkünfte & Hütten',whereToStay:'Glas-Iglus, Hütten, Lodges',familyFriendly:'Familienresorts + Weihnachtsmann-Besuche',localFood:'Samische Küche & Beerenpflücken',fineDining:'Fine Dining',barsPubs:'Bars & Pubs',activities:'Handverlesene arktische Aktivitäten',huskySafaris:'Husky-Safaris, Anbieter im Vergleich',skiResorts:'Skigebiete im Vergleich',snowmobileTours:'Schneemobil-Safaris & Vermietung',spaWellness:'Saunas, Spas, Polarlicht-Wellness',nightlife:'Nachtleben',natureParks:'Natur & Parks',travelGuide:'Reiseführer',christmas:'Weihnachten in Lappland, Weihnachtsmanndorf, Polarlicht',giftsSouvenirs:'Geschenke & Souvenirs',travelBlog:'Reiseblog',dealsOffers:'Angebote',transport:'Transport',carRental:'Mietwagen',workInLapland:'Arbeiten in Lappland' },
  ja: { hotelDeals:'厳選ホテル特価',staysCabins:'宿泊・コテージ',whereToStay:'グラスイグルー、コテージ、ロッジ',familyFriendly:'ファミリーリゾート＋サンタクロースとの出会い',localFood:'サーミ料理＋ベリー摘み',fineDining:'ファインダイニング',barsPubs:'バー・パブ',activities:'厳選北極圏アクティビティ',huskySafaris:'ハスキーサファリ、事業者比較',skiResorts:'スキーリゾート比較',snowmobileTours:'スノーモービルサファリ・レンタル',spaWellness:'サウナ、スパ、オーロラ・ウェルネス',nightlife:'ナイトライフ',natureParks:'自然と公園',travelGuide:'旅行ガイド',christmas:'ラップランドのクリスマス：サンタ村、オーロラ',giftsSouvenirs:'ギフト・お土産',travelBlog:'旅行ブログ',dealsOffers:'お得な情報',transport:'交通',carRental:'レンタカー',workInLapland:'ラップランドで働く' },
...
const EXT_SITE_LABELS: Record<string, Record<ExtLabelsKey, string>> = {
  ...
  'pt-BR': { luxuryVillas:'Vilas privativas e lodges de luxo', tours:'Tours guiados e bate-voltas', weddings:'Casamentos no Ártico', store:'Lojas e artesãos da Lapônia', flights:'Voos para a Lapônia' },
  ...
  nl: { luxuryVillas:"Privévilla's & luxe lodges", tours:'Begeleide tours & dagtrips', weddings:'Arctische bruiloften', store:'Lapland-winkels & makers', flights:'Vluchten naar Lapland' },
