...
const COPY: Record<Lang, {
  ...
  en: {
    ...
    s2Body: 'We collect pseudonymous analytics data via Google Analytics 4. If you subscribe to our newsletter, we store your email address securely. We do not collect any other personally identifiable information unless you contact us directly.',
    ...
    s2Body: 'Keräämme pseudonyymejä kävijäanalytiikkatietoja Google Analytics 4:n kautta. Jos tilaat uutiskirjeemme, tallennamme sähköpostiosoitteesi turvallisesti. Emme kerää muuta tunnistettavaa henkilötietoa, ellet ota meihin yhteyttä suoraan.',
  ...
  de: {
    ...
    s2Body: 'Wir erheben pseudonyme Analysedaten über Google Analytics 4. Wenn Sie unseren Newsletter abonnieren, speichern wir Ihre E-Mail-Adresse sicher. Weitere personenbezogene Daten erheben wir nicht, sofern Sie uns nicht direkt kontaktieren.',
  ...
  es: {
    ...
    s2Body: 'Recopilamos datos analíticos seudonimizados a través de Google Analytics 4. Si se suscribe a nuestro boletín, almacenamos su dirección de correo electrónico de forma segura. No recogemos ningún otro dato personal identificable salvo que usted nos contacte directamente.',
  ...
  'pt-BR': {
    ...
    s2Body: 'Coletamos dados analíticos pseudonimizados por meio do Google Analytics 4. Se você se inscrever em nosso boletim, armazenamos seu endereço de e-mail com segurança. Não coletamos nenhuma outra informação pessoal identificável, a menos que você entre em contato conosco diretamente.',
  ...
  'zh-CN': {
    ...
    s2Title: '2. 我们收集的数据',
    s2Body: '我们通过 Google Analytics 4 收集假名化的访问分析数据。如果您订阅了我们的电子简报，我们会安全地存储您的电子邮件地址。除非您直接与我们联系，否则我们不会收集任何其他可识别个人身份的信息。',
  ...
  ko: {
    ...
    s2Title: '2. 수집하는 데이터',
    s2Body: '당사는 Google Analytics 4를 통해 가명 처리된 분석 데이터를 수집합니다. 뉴스레터를 구독하시면 귀하의 이메일 주소를 안전하게 보관합니다. 귀하가 당사에 직접 연락하시지 않는 한, 그 외의 식별 가능한 개인정보는 수집하지 않습니다.',
  ...
  fr: {
    ...
    s2aItems: [
      ...
      { strong: 'Consentement (Art. 6(1)(a))', body: 'pour l\'abonnement à l\'newsletter. Vous donnez votre consentement en soumettant le formulaire et pouvez le retirer à tout moment via le lien de désinscription.' },
    ...
    s6Body: 'Les données analytiques sont conservées 14 mois dans Google Analytics. Les adresses e-mail de l\'newsletter sont conservées jusqu\'à votre désinscription.',
    s7Title: '7. Tiers',
    ...
    s7Items: [
      ...
      'Resend, envoi de l\'newsletter par e-mail',
  ...
  it: {
    ...
    s2Body: 'Raccogliamo dati analitici pseudonimi tramite Google Analytics 4. Se Lei si iscrive alla nostra newsletter, conserviamo il Suo indirizzo email in modo sicuro. Non raccogliamo altre informazioni personali identificabili, salvo Lei ci contatti direttamente.',
  ...
  nl: {
    ...
    s2Body: 'Wij verzamelen gepseudonimiseerde analysegegevens via Google Analytics 4. Als u zich abonneert op onze nieuwsbrief, slaan wij uw e-mailadres veilig op. Wij verzamelen geen andere identificeerbare persoonsgegevens, tenzij u rechtstreeks contact met ons opneemt.',
    ...
    s3Items: [
      ...
      { strong: 'Analyse-cookies', body: 'gebruikt door Google Analytics 4 om te begrijpen hoe bezoekers onze site gebruiken. Gepseudonimiseerd verzameld.' },
  ...
  sv: {
    ...
    s2Body: 'Vi samlar in pseudonym analysdata via Google Analytics 4. Om du prenumererar på vårt nyhetsbrev lagrar vi din e-postadress säkert. Vi samlar inte in några andra personuppgifter som kan identifiera dig, om du inte kontaktar oss direkt.',
