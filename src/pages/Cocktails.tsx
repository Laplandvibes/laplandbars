    ...
    <>
      ...
      <section className="py-16 bg-night/95 aurora-glow">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {ingredients.map((ing) => (
              <div key={ing.name} className="bar-card bar-card-hover p-6">
      ...
      <section className="py-16 bg-night/95">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bar-card bg-gradient-to-br from-amber/[0.07] via-night/0 to-ice/[0.04] p-8 sm:p-10 text-center">
      ...
      <section className="py-14 bg-night">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bar-card p-6 sm:p-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
