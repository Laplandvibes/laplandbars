...
// cadence the consumer newsletter has never kept (0 sends). Do not re-add
// per-site copy overrides here — the shared founder default is the network
// standard on every tourism site.
